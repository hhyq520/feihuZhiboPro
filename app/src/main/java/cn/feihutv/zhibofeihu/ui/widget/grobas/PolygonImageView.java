package cn.feihutv.zhibofeihu.ui.widget.grobas;
...
import cn.feihutv.zhibofeihu.ui.widget.grobas.shape.PolygonShape;
import cn.feihutv.zhibofeihu.ui.widget.grobas.shape.PolygonShapeSpec;
import cn.feihutv.zhibofeihu.ui.widget.grobas.shape.RegularPolygonShape;

/**
 * <pre>
 *      author : liwen.chen
 *      time   : 2017/10/24 16:59
 *      desc   : 绘制多边形图片
 *      version: 1.0
 * </pre>
...
public class PolygonImageView extends ImageView {
    ...
    public PolygonImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            mPolygonShapeSpec.setShadowColor(attributes.getColor(R.styleable.PolygonImageView_poly_shadow_color, Color.parseColor("#eaeaea")));
