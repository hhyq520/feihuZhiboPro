...
import cn.feihutv.zhibofeihu.ui.widget.RotateTextView;
import cn.feihutv.zhibofeihu.ui.widget.dialog.BaseDialog;
...
//        Log.e("CustomVersionDialogActi", "正在下载中回调...");
    ...
    private void customVersionDialogTwo() {
        versionDialog = new BaseDialog(this, R.style.BaseDialog, R.layout.custom_dialog_layout);
        RotateTextView rotateTextView= (RotateTextView) versionDialog.findViewById(R.id.tv_versionCode);
        TextView tvMsg = (TextView) versionDialog.findViewById(R.id.text_desc);
        ...
        rotateTextView.setText(getVersionTitle());
