...
import cn.feihutv.zhibofeihu.ui.widget.grobas.PolygonImageView;
 ...
 * </pre>
 */
public class ConFragment extends BaseFragment implements ConMvpView, StatusView.ClickRefreshListener, VRefreshLayout.OnRefreshListener, View.OnClickListener {

    @Inject
    ConMvpPresenter<ConMvpView> mPresenter;
    ...
    private ImageView ivLevel1, ivLevel2, ivLevel3, ivVip1, ivVip2, ivVip3;
    ...
    public static ConFragment newInstance(String rankType) {
        ConFragment fragment = new ConFragment();
    ...
    protected void initWidget(View view) {
        ...
        //Presenter调用初始化
        mPresenter.onAttach(ConFragment.this);
        ...
        mHeadView = LayoutInflater.from(getContext()).inflate(R.layout.view_head_bangdan, null);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                goOtherPersonCenter(mAdapterDatas.get(position).getUserId());
            }
        });
    ...
    protected void lazyLoad() {
        ...
        if (isPrepared && isVisible && mRankListResponseDatas.size() == 0) {
            isPrepared = false;
            mPresenter.loadContriRankList(mRankType);
        }
    }
    ...
    public void getDatas(List<LoadContriRankListResponse.LoadContriRankListResponseData> rankListResponseData) {
        AppLogger.i("rankListResponseData" + rankListResponseData);
        if (isRefresh) {
    ...
    public void showNodataView() {
        if (isFirstLoad) {
            ...
            mStatusView.setTvNoData("暂没数据哦，主播在等你刷点礼物呢~");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.polygonImageView_1:
                goOtherPersonCenter(mRankListResponseDatas.get(0).getUserId());
                break;
            case R.id.polygonImageView_2:
                goOtherPersonCenter(mRankListResponseDatas.get(1).getUserId());
                break;
            case R.id.polygonImageView_3:
                goOtherPersonCenter(mRankListResponseDatas.get(2).getUserId());
                break;
            default:
                break;
        }
    ...
    private void goOtherPersonCenter(String userId) {
