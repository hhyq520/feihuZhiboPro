...
public class MyReceiveAdapter extends BaseQuickAdapter<GetVipReceiveLogResponse.ReceiveLogList, BaseViewHolder> {


    public MyReceiveAdapter(@Nullable List<GetVipReceiveLogResponse.ReceiveLogList> data) {
        super(R.layout.item_layout_my_receive, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, GetVipReceiveLogResponse.ReceiveLogList item) {
