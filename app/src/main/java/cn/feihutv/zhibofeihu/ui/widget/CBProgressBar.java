...
public class CBProgressBar extends View {
     ...
     * 进度条背景颜色
     **/
    private int progressBarBgColor = 0xffC1C0C0;
    /**
     * 进度颜色
     **/
    private int progressColor = 0xffFFBB00;
    /**
     * 扇形扫描进度的颜色
     */
    private int sectorColor=0xff303030;
    /**
     * 扇形扫描背景
     */
    private int unSweepColor = 0x303030;
    /**
     * 进度条样式（水平/圆形）
     **/
