 ...
 * </pre>
 */
public class FansActivity extends BaseActivity implements FansMvpView, SwipeRefreshLayout.OnRefreshListener, StatusView.ClickRefreshListener {
    ...
    @Inject
    FansMvpPresenter<FansMvpView> mPresenter;
    ...
    protected void initWidget() {
        ...
        //persenter调用初始化
        mPresenter.onAttach(FansActivity.this);
        ...
        mPresenter.getFollowers(offset);
    ...
    public void showNoData() {
        if (isFirstLoad) {
            ...
            mStatusView.setTvNoData("暂无粉丝哦，快去展示你的才艺吧~");
            hideLoading();
        }
        if (isLoadEnd) {
