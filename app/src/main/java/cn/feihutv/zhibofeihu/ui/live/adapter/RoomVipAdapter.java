...
public class RoomVipAdapter extends BaseQuickAdapter<RoomVipResponce.RoomVipModel, BaseViewHolder> {

    public RoomVipAdapter(@Nullable List<RoomVipResponce.RoomVipModel> data) {
        super(R.layout.item_layout_roomvip, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, RoomVipResponce.RoomVipModel item) {
