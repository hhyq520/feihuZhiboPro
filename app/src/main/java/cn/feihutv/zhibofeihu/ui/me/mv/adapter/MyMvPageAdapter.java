...
public class MyMvPageAdapter extends RecyclerView.Adapter<MyMvPageAdapter.ViewHolder> {
    ...
    public List<GetMyCustomMadeMVListResponse.GetMyCustomMadeMVList> datas = null;
    private ItemClickCallBack clickCallBack;

    public MyMvPageAdapter(Context mContext,List<GetMyCustomMadeMVListResponse.GetMyCustomMadeMVList> datas) {
        this.datas = datas;
    ...
    public void onBindViewHolder(ViewHolder viewHolder,final int position) {
        ...
        GetMyCustomMadeMVListResponse.GetMyCustomMadeMVList mvList=  datas.get(position);
        ...
        viewHolder.mv_user_desc.setText("");
        viewHolder.mv_comment.setText(mvList.getComments()+"");
        viewHolder.mv_play_num.setText("播放次数:" +"");
