...
public class RxTextTool {
    ...
    public static class Builder {
        ...
        public Builder setFontType(@Nullable String fontType) {
        ...
        private void setSpan() {
            ...
            if (fontType != null) {
                if(fontType.equals("normal")) {
                    mBuilder.setSpan(FontsUtil.getInstance(RxTool.getContext()).getMyNumTypefaceSpan(), start, end, flag);
                }else {
                    mBuilder.setSpan(FontsUtil.getInstance(RxTool.getContext()).getMyCharTypefaceSpan(), start, end, flag);
                }
                fontType = null;
            }
