 ...
 * </pre>
 */
public class GuardsPresenter<V extends GuardsMvpView> extends BasePresenter<V>
        implements GuardsMvpPresenter<V> {


    @Inject
    public GuardsPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
