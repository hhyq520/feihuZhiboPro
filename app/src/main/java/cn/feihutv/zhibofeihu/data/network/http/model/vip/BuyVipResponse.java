...
public class BuyVipResponse extends BaseResponse {
    ...
    @Expose
    @SerializedName("Data")
    private BuyVipData mBuyVipData;

    public BuyVipData getBuyVipData() {
        return mBuyVipData;
    }

    public void setBuyVipData(BuyVipData buyVipData) {
        mBuyVipData = buyVipData;
    }

    public static class BuyVipData {
        @Expose
        @SerializedName("Vip")
        ...
        private long vipExpireTime;   //购买后的过期时间
